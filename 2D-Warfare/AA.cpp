...
AA::AA() :animation(IntRect(Vector2i(6,2),Vector2i(38,82)))
{
	aa = this;
	aa->setEntity(anti_air, Vector2f(1000.f, 1000.f), animation, "AA");
	speed = 25;
